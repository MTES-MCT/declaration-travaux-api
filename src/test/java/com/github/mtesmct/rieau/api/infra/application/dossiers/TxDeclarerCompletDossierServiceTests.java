...
public class TxDeclarerCompletDossierServiceTests {
        @MockBean
        ...
        public void executeInstructeurTest() throws AuthRequiredException, UserForbiddenException,
        ...
        Optional<Dossier> dossierComplet = this.declarerCompletDossierService.execute(this.dossier.identity());
        assertTrue(dossierComplet.isPresent());
        assertEquals(this.dossier.identity(), dossierComplet.get().identity());
        assertTrue(dossierComplet.get().statutActuel().isPresent());
        assertEquals(EnumStatuts.COMPLET, dossierComplet.get().statutActuel().get().type().identity());
    }
    ...
    public void executeAutreInstructeurInterditTest() throws AuthRequiredException, UserForbiddenException,
        ...
        assertThrows(InstructeurForbiddenException.class,
                () -> this.declarerCompletDossierService.execute(this.otherDossier.identity()));
    }
    ...
    public void executeDeposantInterditTest() throws Exception {
        ...
        assertThrows(UserForbiddenException.class,
                () -> this.declarerCompletDossierService.execute(this.dossier.identity()));
    }
}