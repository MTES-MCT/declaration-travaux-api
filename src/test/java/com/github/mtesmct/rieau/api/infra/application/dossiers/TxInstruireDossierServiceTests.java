...
public class TxInstruireDossierServiceTests {
    @MockBean
    private DossierRepository dossierRepository;

    @Autowired
    private TxInstruireDossierService service;
    @Autowired
    ...
    public void executeInstructeurTest() throws AuthRequiredException, UserForbiddenException, UserInfoServiceException,
        ...
        Optional<Dossier> dossierComplet = this.service.execute(this.dossier.identity());
        ...
        assertEquals(EnumStatuts.INSTRUCTION, dossierComplet.get().statutActuel().get().type().identity());
    }
    ...
    public void executeAutreInstructeurInterditTest() throws AuthRequiredException, UserForbiddenException,
        ...
        assertThrows(InstructeurForbiddenException.class,
                () -> this.service.execute(this.otherDossier.identity()));
    }
