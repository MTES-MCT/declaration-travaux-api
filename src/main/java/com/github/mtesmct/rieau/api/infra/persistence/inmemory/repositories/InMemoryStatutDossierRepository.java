...
public class InMemoryStatutDossierRepository implements TypeStatutDossierRepository {
    ...
    public void init() {
        ...
        this.types.put(EnumStatuts.INSTRUCTION,
                new TypeStatut(EnumStatuts.INSTRUCTION, 2, false, "en cours d'instruction", 30));
        ...
        this.types.put(EnumStatuts.CONSULTATIONS,
                new TypeStatut(EnumStatuts.CONSULTATIONS, 4, true, "consultations en cours", 10));
