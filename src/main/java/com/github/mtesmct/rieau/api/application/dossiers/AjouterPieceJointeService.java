...
public interface AjouterPieceJointeService {
    public Optional<PieceJointe> execute(Dossier dossier, String numero, Fichier fichier) throws PieceNonAJoindreException, AjouterPieceJointeException, AuthRequiredException, UserForbiddenException, UserServiceException;
}
