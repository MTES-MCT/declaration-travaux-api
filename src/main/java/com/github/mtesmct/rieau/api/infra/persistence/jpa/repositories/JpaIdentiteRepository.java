...
public class JpaIdentiteRepository implements IdentiteRepository {
    ...
    @Autowired
    private JpaRepository<JpaIdentite, String> jpaRepository;

    @Override
    public Optional<Identite> findById(String id) {
        Optional<JpaIdentite> jpaEntity = this.jpaRepository.findById(id);
    ...
    public Identite save(Identite identite) {
        ...
        this.jpaRepository.save(jpaIdentite);
