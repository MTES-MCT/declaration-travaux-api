...
public class CommonHttpConfigurer extends AbstractHttpConfigurer<CommonHttpConfigurer, HttpSecurity> {
    ...
    public void init(HttpSecurity http) throws Exception {
        http.csrf().disable().sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
                ...
                .antMatchers(HttpMethod.POST, DossiersController.ROOT_URI + "/*" + DossiersController.INSTRUIRE_URI)
                ...
                .hasRole(Roles.INSTRUCTEUR)
                .antMatchers(HttpMethod.POST, DossiersController.ROOT_URI + "/*" + DossiersController.LANCER_CONSULTATIONS_URI)
                .hasRole(Roles.INSTRUCTEUR)
