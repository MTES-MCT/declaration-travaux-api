        ...
        public void initUsers() throws CommuneNotFoundException {
                ...
                this.users.put(MockUsers.JEAN_MARTIN,
                                this.userFactory.creer(MockUsers.JEAN_MARTIN, MockUsers.JEAN_MARTIN + EMAIL_DOMAIN,
                                                Sexe.HOMME, capitalizeFirstLetter(noms(MockUsers.JEAN_MARTIN)[1]),
                                                capitalizeFirstLetter(noms(MockUsers.JEAN_MARTIN)[0]), "44100", "1", "rue des Fleurs", "", "",
                                                "", new String[] { Roles.DEPOSANT, Roles.BETA }));
                this.users.put(MockUsers.JACQUES_DUPONT, this.userFactory.creer(MockUsers.JACQUES_DUPONT,
                                MockUsers.JACQUES_DUPONT + EMAIL_DOMAIN, Sexe.HOMME, capitalizeFirstLetter(noms(MockUsers.JACQUES_DUPONT)[1]),
                                capitalizeFirstLetter(noms(MockUsers.JACQUES_DUPONT)[0]), "44100", "1", "rue des Fleurs", "", "", "",
                                new String[] { Roles.INSTRUCTEUR }));
                this.users.put(MockUsers.CLAIRE_DENIS, this.userFactory.creer(MockUsers.CLAIRE_DENIS,
                                MockUsers.CLAIRE_DENIS + EMAIL_DOMAIN, Sexe.FEMME, capitalizeFirstLetter(noms(MockUsers.CLAIRE_DENIS)[1]),
                                capitalizeFirstLetter(noms(MockUsers.CLAIRE_DENIS)[0]), "44100", "1", "rue des Fleurs", "", "", "",
                                new String[] { Roles.DEPOSANT, Roles.BETA }));
                this.users.put(MockUsers.MADAME_LE_MAIRE, this.userFactory.creer(MockUsers.MADAME_LE_MAIRE,
                                ...
                                capitalizeFirstLetter(noms(MockUsers.MADAME_LE_MAIRE)[1]), capitalizeFirstLetter(noms(MockUsers.MADAME_LE_MAIRE)[0]), "44100", "1",
