...
public interface LireFichierService {
    public Optional<Fichier> execute(FichierId id) throws FichierNotFoundException, UserForbiddenException, AuthRequiredException, UserInfoServiceException, UserNotOwnerException;
}